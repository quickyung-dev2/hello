#Downloads
curl -s -o login.sh -L "https://raw.githubusercontent.com/quickyung-dev2/hello/refs/heads/main/.github/workflows/login.sh"
...
sudo dscl . -passwd /Users/runneradmin 123456Hi
sudo dscl . -passwd /Users/runneradmin 123456Hi
